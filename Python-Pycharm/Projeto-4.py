...
#print('O seu sucessor é: {} \nE seu antecessor é: {}'.format(n1 + 1, n1 - 1))
...
#t = n1 * 3
#r = n1 ** (1/2)
#print('O dobro é: {} \nO triplo é: {} \nA raiz quadrada é: {:.0f}'.format(d, t, r))

#Desafio 007 - Desenvolva um programa que leia as duas notas de um aluno, calcule e mostre sua média.
#nota1 = float(input('Primeira nota: '))
#nota2 = float(input('Segunda nota: '))
#media = (nota1 + nota2) / 2
#print('A primeira nota: {} e a segunda nota: {} \nA média final é: {}'.format(nota1, nota2, media))
#if media > 6:
    #print('Aprovado')
#else:
    #print('Reprovado')
...
#print('-' * 20)
#print('{:2} * {:2} = {:2}'.format(0, tab, tab * 0))
#print('{:2} * {:2} = {:2}'.format(1, tab, tab * 1))
#print('{:2} * {:2} = {:2}'.format(2, tab, tab * 2))
#print('{:2} * {:2} = {:2}'.format(3, tab, tab * 3))
#print('{:2} * {:2} = {:2}'.format(4, tab, tab * 4))
#print('{:2} * {:2} = {:2}'.format(5, tab, tab * 5))
#print('{:2} * {:2} = {:2}'.format(6, tab, tab * 6))
#print('{:2} * {:2} = {:2}'.format(7, tab, tab * 7))
#print('{:2} * {:2} = {:2}'.format(8, tab, tab * 8))
#print('{:2} * {:2} = {:2}'.format(9, tab, tab * 9))
#print('{:2} * {:2} = {:2}'.format(10, tab, tab * 10))
